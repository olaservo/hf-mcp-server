...
export const DEEP_RESEARCH_SEARCH_TOOL_ID = DEEP_RESEARCH_SEARCH_CONFIG.name;
export const DEEP_RESEARCH_FETCH_TOOL_ID = DEEP_RESEARCH_FETCH_CONFIG.name;
...
export const ALL_BUILTIN_TOOL_IDS = [
	...
	DOC_FETCH_TOOL_ID,
	DEEP_RESEARCH_SEARCH_TOOL_ID,
	DEEP_RESEARCH_FETCH_TOOL_ID,
	USE_SPACE_TOOL_ID,
] as const;
...
export const TOOL_ID_GROUPS = {
	...
	docs: [DOCS_SEMANTIC_SEARCH_TOOL_ID, DOC_FETCH_TOOL_ID, DEEP_RESEARCH_SEARCH_TOOL_ID, DEEP_RESEARCH_FETCH_TOOL_ID] as const,
	hf_api: [
		SPACE_SEARCH_TOOL_ID,
		MODEL_SEARCH_TOOL_ID,
		DATASET_SEARCH_TOOL_ID,
